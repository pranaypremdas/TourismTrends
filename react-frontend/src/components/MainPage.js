				...
				<Col md={6} className="mb-4">
					<Card>
						<Card.Body>
							...
							<Button variant="primary" href="/admin/data">
								Upload Data
							</Button>
						</Card.Body>
					</Card>
				...
				<Col md={6} className="mb-4">
					<Card>
						<Card.Body>
							...
							<Card.Text>
								Provide access to your team members to collaborate on data so
								that each team member has access to the most up-to-date
								information.
							</Card.Text>
